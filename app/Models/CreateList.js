...
export default class CreateList{
    ...
    get Template(){
        return /*html*/ `
         <div class="col-lg-4 mt-5 ml-3 mr-3 mb-5 card rounded shadow-lg text-center pr-5">
                        ...
                        <h6 class="mb-3">Tasks: ${this.AllTasks} <span class="ml-5 text-danger">Uncompleted Tasks: ${this.CompletedTasks}</h6>
